 ...
 **/
(function(t) {
    function e(e) { return u ? e.data("events") : t._data(e[0]).events }

    function n(t, n, r) {
        var i = e(t),
            a = i[n];
        if (!u) { var s = r ? a.splice(a.delegateCount - 1, 1)[0] : a.pop(); return a.splice(r ? 0 : a.delegateCount || 0, 0, s), void 0 }
    ...
    }, t.fn.liveFirst = function() { var e = t.makeArray(arguments); return e.unshift(this.selector), t.fn.delegateFirst.apply(t(document), e), this }, u || (t.fn.onFirst = function(e, n) {
        var i = t(this),
            a = "string" == typeof n;
...
(function($) {
        ...
        run: function(form) {
            ...
            if (cont > 0) {
                swal.fire({
                    icon: 'error',
                    title: 'Error',
                    html: '<p class="text-danger">Por favor, rellene los campos obligatorios antes de Guardar</p>',
                })
    ...
    // First verify that input exists and is a valid jQuery object
