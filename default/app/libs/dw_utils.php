...
class DwUtils {
    ...
    public static function print_r($v, $v1=NULL, $v2=NULL, $v3=NULL, $v4=NULL, $v5=NULL, $v6=NULL, $v7=NULL, $v8=NULL, $v9=NULL) {
        echo '<pre>';
        echo 'Variable 1: <br>';print_r($v); echo '<br>';
        echo (is_null($v1) ?'':'Variable 2: <br>');(is_null($v1)?die():print_r($v1));echo '<br>';
        echo (is_null($v2) ?'':'Variable 3: <br>');(is_null($v2)?die():print_r($v2));echo '<br>';
        echo (is_null($v3) ?'':'Variable 4: <br>');(is_null($v3)?die():print_r($v3));echo '<br>';
        echo (is_null($v4) ?'':'Variable 5: <br>');(is_null($v4)?die():print_r($v4));echo '<br>';
        echo (is_null($v5) ?'':'Variable 6: <br>');(is_null($v5)?die():print_r($v5));echo '<br>';
        echo (is_null($v6) ?'':'Variable 7: <br>');(is_null($v6)?die():print_r($v6));echo '<br>';
        echo (is_null($v7) ?'':'Variable 8: <br>');(is_null($v7)?die():print_r($v7));echo '<br>';
        echo (is_null($v8) ?'':'Variable 9: <br>');(is_null($v8)?die():print_r($v8));echo '<br>';
        echo (is_null($v9) ?'':'Variable 10: <br>');(is_null($v9)?die():print_r($v9));echo '<br>';
        die();
    }
