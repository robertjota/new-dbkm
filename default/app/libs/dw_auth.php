...
class DwAuth
{
    ...
    public static function login($fieldUser, $fieldPass)
    {
        ...
        if (self::isLogged()) {
            ...
            //DwUtils::print_r($keyUser, $keyPass, $valUser, $valPass);
            ...
            $auth->setFields(array('id', 'nombre', 'apellido', 'login', 'tema', 'email', 'estado', 'app_ajax', 'datagrid', 'perfil_id', 'pool', 'fotografia'));
