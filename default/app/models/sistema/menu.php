 ...
 * @subpackage
 */
Load::models('sistema/recurso', 'sistema/recurso_perfil', 'sistema/usuario', 'sistema/perfil');
class Menu extends ActiveRecord
{
    ...
    //public static function get_menu_multinivel($entorno = '', $perfil = '')
     ...
     */
    public function getMenusPorPadre($padre, $order = 'padre_posicion ASC, menu.posicion ASC')
    {
    ...
    public function getMenuActivoByEntorno($entorno)
    {
        $conditions = "menu.visibilidad = $entorno AND menu.activo = " . self::ACTIVO;
        $group      = 'menu.id';
        $order      = 'menu.posicion ASC';
        return $this->find("conditions: $conditions", "group: $group", "order: $order");
    }

    public function getMenuActivoByEntornoAndPerfil($entorno = '', $perfil = '')
    {
        $columns = 'menu.*';
        $join = 'LEFT JOIN recurso ON recurso.id = menu.recurso_id ';
        $join .= 'LEFT JOIN recurso_perfil ON recurso.id = recurso_perfil.recurso_id ';
